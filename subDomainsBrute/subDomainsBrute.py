...
class SubNameBrute:
    ...
    def _load_dns_servers(self):
        ...
        with open('subDomainsBrute/dict/dns_servers.txt') as f:
            for line in f:
                server = line.strip()
                while True:
    ...
    def _test_server(self, server):
        ...
        try:
            ...
            try:
                ...
                with open('subDomainsBrute/bad_dns_servers.txt', 'a') as f:
                    f.write(server + '\n')
    ...
    def _load_sub_names(self):
        ...
        if self.options.full_scan:
            ...
            _file = 'subDomainsBrute/dict/subnames.txt'
        sub_names = set()
        lst_subs = []
    ...
    def _load_next_sub(self):
        ...
        next_subs = []
        _file = 'subDomainsBrute/dict/next_sub.txt' if not self.options.full_scan else 'subDomainsBrute/dict/next_sub_full.txt'
        with open(_file) as f:
            for line in f:
                sub = line.strip()
